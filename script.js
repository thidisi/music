  ...
  playMusic: function () {
        ...
        if (!isDrag) {
          ...
          if (audio.currentTime == audio.duration) {
            audio.onpause = function () {
              ...
              $(`[data-index="${app.currentIndex}"]`).classList.remove(
                "playing"
              );
    ...
    progress.oninput = function () {
      ...
      if (secleft < 10) {
        if (secleft < 0) {
          $(".sec-left").innerText =
            60 + secleft < 10 ? "0" + (60 + secleft) : 60 + secleft;
...
$(".fa-moon").onclick = function () {
  ...
  $(".app_color").style.background = "url(./assets/img/nitg.jpg)  no-repeat";
  $(".app_color").style.backgroundSize = "cover";
  $(".app_color").style.backgroundPosition = "center center";
};
...
$(".fa-sun").onclick = function () {
  ...
  $(".app_color").style.background = "url(./assets/img/background.jpg)  no-repeat";
  $(".app_color").style.backgroundSize = "cover";
  $(".app_color").style.backgroundPosition = "center center";
};
